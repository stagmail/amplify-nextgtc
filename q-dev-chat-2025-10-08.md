...
I got error when running &#39;npx ampx sandbox&#39;:     ∟ Caused by: [InvalidSchemaError] Unable to find associated relationship definition in Driver for PooledJob.driver: Driver @belongsTo(references: [&#39;driverId&#39;])
      ∟ Caused by: [Error] Unable to find associated relationship definition in Driver for PooledJob.driver: Driver @belongsTo(references: [&#39;driverId&#39;])
...
5. Go to "Users" tab
6. Select your user → "Add user to group" → Select `controller`
